...
public class GuiCrucible extends GuiBaseAdv {
	...
	public void initGui() {
		...
		progressOverlay = (ElementDualScaled) addElement(new ElementDualScaled(this, 103, 34).setMode(1).setBackground(false).setSize(24, 16).setTexture(TEX_DROP_RIGHT, 48, 16));
