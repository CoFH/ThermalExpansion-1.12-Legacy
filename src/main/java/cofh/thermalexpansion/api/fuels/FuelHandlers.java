...
/**
 * This class allows for advanced Fuel Handler interfacing. Use it only if you absolutely know what you are doing and have a specific need. Otherwise, IMC is
 * the safest and most reliable way to interface BY FAR. If Thermal Expansion is not present, these fields can and WILL be NULL.
 *
