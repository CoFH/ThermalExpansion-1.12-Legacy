...
public class TileDynamoSteam extends TileDynamoBase {
	...
	protected void transferSteam() {
		...
		steamTank.modifyFluidStored(-FluidHelper.insertFluidIntoAdjacentFluidHandler(worldObj, pos, EnumFacing.values()[facing], new FluidStack(steamTank.getFluid(), energyConfig.maxPower * 2), true));
	}
