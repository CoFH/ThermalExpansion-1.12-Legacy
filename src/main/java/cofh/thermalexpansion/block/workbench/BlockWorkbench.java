...
public class BlockWorkbench extends BlockTEBase implements IBlockTextureProvider {
    ...
    public boolean postInit() {
        ...
        if (enable[EnumType.BASIC.ordinal()]) {
            GameRegistry.addRecipe(new RecipeUpgrade(7, workbenchBasic, new Object[] { " X ", "ICI", " P ", 'C', Blocks.CRAFTING_TABLE, 'I', "ingotCopper", 'P', BlockStrongbox.strongboxBasic, 'X', Items.PAPER }));
        ...
        if (enable[EnumType.HARDENED.ordinal()]) {
            ...
            GameRegistry.addRecipe(new RecipeUpgrade(7, workbenchHardened, new Object[] { "IPI", "CTC", "IBI", 'T', Blocks.CRAFTING_TABLE, 'C', "ingotCopper", 'B', BlockStrongbox.strongboxBasic, 'P', Items.PAPER, 'I', "ingotInvar" }));
        }
