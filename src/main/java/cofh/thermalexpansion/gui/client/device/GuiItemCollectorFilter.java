...
public class GuiItemCollectorFilter extends GuiDeviceBase {
	...
	public GuiItemCollectorFilter(InventoryPlayer inventory, TileEntity tile) {
	...
	public void handleElementButtonClick(String buttonName, int mouseButton) {
		...
		ContainerItemCollectorFilter container = (ContainerItemCollectorFilter) inventorySlots;
		int flag = 0;
		switch (buttonName) {
			case "FilterList":
