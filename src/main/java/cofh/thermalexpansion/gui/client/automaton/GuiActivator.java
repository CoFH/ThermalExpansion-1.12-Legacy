...
import cofh.thermalexpansion.gui.container.automaton.ContainerActivator;
import cofh.thermalexpansion.init.TEProps;
import net.minecraft.entity.player.InventoryPlayer;
import net.minecraft.tileentity.TileEntity;
import net.minecraft.util.ResourceLocation;

public class GuiActivator extends GuiPoweredBase {
	...
	public void initGui() {
		...
		settingClick = new ElementButton(this, 120, 20, "LeftClick", myTile.leftClick ? 176 : 196, 0, myTile.leftClick ? 176 : 196, 20, 20, 20, TEX_PATH).setToolTip(myTile.leftClick ? "info.thermalexpansion.clickLeft" : "info.thermalexpansion.clickRight");
		settingSneak = new ElementButton(this, 144, 20, "Sneak", myTile.actsSneaking ? 176 : 196, 60, myTile.actsSneaking ? 176 : 196, 80, 20, 20, TEX_PATH).setToolTip(myTile.actsSneaking ? "info.thermalexpansion.sneakOn" : "info.thermalexpansion.sneakOff");
		settingSlot = new ElementButton(this, 120, 44, "tickSlot", myTile.tickSlot == 0 ? 176 : myTile.tickSlot == 1 ? 196 : 216, 120, myTile.tickSlot == 0 ? 176 : myTile.tickSlot == 1 ? 196 : 216, 140, 20, 20, TEX_PATH).setToolTip(myTile.tickSlot == 0 ? "info.thermalexpansion.slotsRR" : myTile.tickSlot == 1 ? "info.thermalexpansion.slotsRand" : "info.thermalexpansion.slotsFirst");
		settingAngle = new ElementButton(this, 144, 44, "Angle", myTile.angle == 0 ? 176 : myTile.angle == 1 ? 196 : 216, 180, myTile.angle == 0 ? 176 : myTile.angle == 1 ? 196 : 216, 200, 20, 20, TEX_PATH).setToolTip(myTile.angle == 0 ? "info.thermalexpansion.angleLow" : myTile.angle == 1 ? "info.thermalexpansion.angleLevel" : "info.thermalexpansion.angleHigh");
	...
	public void handleElementButtonClick(String buttonName, int mouseButton) {
		...
		if (buttonName.equalsIgnoreCase("LeftClick")) {
			...
			playClickSound(1.0F, myTile.leftClick ? 0.8F : 0.6F);
			...
			playClickSound(1.0F, myTile.actsSneaking ? 0.6F : 0.8F);
		} else if (buttonName.equalsIgnoreCase("tickSlot")) {
			myTile.tickSlot++;
			myTile.tickSlot %= 3;
			settingSlot.setToolTip(myTile.tickSlot == 0 ? "info.thermalexpansion.slotsRR" : myTile.tickSlot == 1 ? "info.thermalexpansion.slotsRand" : "info.thermalexpansion.slotsFirst");
			...
			playClickSound(1.0F, 0.6F + myTile.tickSlot * 0.1F);
		} else if (buttonName.equalsIgnoreCase("Angle")) {
			myTile.angle++;
			myTile.angle %= 3;
			settingAngle.setToolTip(myTile.angle == 0 ? "info.thermalexpansion.angleLow" : myTile.angle == 1 ? "info.thermalexpansion.angleLevel" : "info.thermalexpansion.angleHigh");
			...
			playClickSound(1.0F, 0.6F + myTile.angle * 0.1F);
		}
