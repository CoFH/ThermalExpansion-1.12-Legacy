...
public class SlotCraftingOutputWorkbenchNew extends Slot {

	EntityPlayer myPlayer;
	TileWorkbench myTile;
	ContainerWorkbenchNew myContainer;

	int amountCrafted;

	public SlotCraftingOutputWorkbenchNew(TileWorkbench tile, ContainerWorkbenchNew container, EntityPlayer player, IInventory inventory, int slotIndex, int x,
			int y) {
