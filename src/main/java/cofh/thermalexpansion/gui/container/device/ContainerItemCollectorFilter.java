...
public class ContainerItemCollectorFilter extends ContainerTileAugmentable implements IFilterable {

	final TileItemCollector myTile;
	final ItemFilterWrapperTile filterWrapper;

	public ContainerItemCollectorFilter(InventoryPlayer inventory, TileEntity tile) {
