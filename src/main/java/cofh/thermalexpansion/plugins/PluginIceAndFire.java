...
public class PluginIceAndFire extends PluginTEBase {
	...
	public void registerDelegate() {
		...
		/* CENTRIFUGE */
		{
			...
			CentrifugeManager.addDefaultMobRecipe("iceandfire:if_pixie", singletonList(getItemStack("pixie_dust")), singletonList(50), 3);
			...
			CentrifugeManager.addDefaultMobRecipe("iceandfire:siren", asList(new ItemStack(Items.PRISMARINE_CRYSTALS, 5), new ItemStack(Items.PRISMARINE_SHARD, 3), getItemStack("shiny_scales", 6)), asList(50, 50, 50), 5);
			CentrifugeManager.addDefaultMobRecipe("iceandfire:hippocampus", singletonList(getItemStack("shiny_scales", 4)), singletonList(50), 2);
		}
	}
