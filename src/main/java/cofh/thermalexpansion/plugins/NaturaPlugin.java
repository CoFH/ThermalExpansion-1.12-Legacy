	...
	public static void initialize() {
		...
		try {
			...
			/* INSOLATOR */
			{
				...
				InsolatorManager.addDefaultRecipe(saguaroFruit, saguaroCactusBaby, null, 0);
				InsolatorManager.addDefaultRecipe(saguaroCactusBaby, ItemHelper.cloneStack(saguaroFruit, 2), saguaroCactus, 0);

				InsolatorManager.addDefaultRecipe(glowshroomGreen, ItemHelper.cloneStack(glowshroomGreen, 2), null, 0, false, Type.NETHER);
				InsolatorManager.addDefaultRecipe(glowshroomBlue, ItemHelper.cloneStack(glowshroomBlue, 2), null, 0, false, Type.NETHER);
				InsolatorManager.addDefaultRecipe(glowshroomPurple, ItemHelper.cloneStack(glowshroomPurple, 2), null, 0, false, Type.NETHER);
			...
			{
				if (seed_oil != null) {
					TransposerManager.addExtractRecipe(2400, seedBarley, null, new FluidStack(seed_oil, 10), 0, false);
					TransposerManager.addExtractRecipe(2400, seedCotton, null, new FluidStack(seed_oil, 10), 0, false);
				}
			}
