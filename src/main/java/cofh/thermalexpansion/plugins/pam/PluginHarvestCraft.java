...
public class PluginHarvestCraft extends PluginTEBase {
	...
	public void initializeDelegate() {
		...
		ItemStack itemBreadfruit = getItemStack("breadfruititem");
		...
		ItemStack itemGuava = getItemStack("guavaitem");
		ItemStack itemHazelnut = getItemStack("hazelnutitem");
		ItemStack itemJackfruit = getItemStack("jackfruititem");
		...
		ItemStack itemLychee = getItemStack("lycheeitem");
		ItemStack itemMango = getItemStack("mangoitem");
		ItemStack itemMapleSyrup = getItemStack("maplesyrupitem");
		...
		ItemStack itemPassionfruit = getItemStack("passionfruititem");
		ItemStack itemPawpaw = getItemStack("pawpawitem");
		...
		ItemStack itemRambutan = getItemStack("rambutanitem");
		...
		ItemStack itemSoursop = getItemStack("soursopitem");
		...
		ItemStack itemTamarind = getItemStack("tamarinditem");
		ItemStack itemTeaLeaf = getItemStack("tealeafitem");
		ItemStack itemVanillaBean = getItemStack("vanillabeanitem");
		...
		ItemStack saplingBreadfruit = getItemStack("breadfruit_sapling");
		...
		ItemStack saplingCinnamon = getItemStack("cinnamon_sapling");
		...
		ItemStack saplingGuava = getItemStack("guava_sapling");
		ItemStack saplingHazelnut = getItemStack("hazelnut_sapling");
		ItemStack saplingJackfruit = getItemStack("jackfruit_sapling");
		ItemStack saplingLemon = getItemStack("lemon_sapling");
		ItemStack saplingLime = getItemStack("lime_sapling");
		ItemStack saplingLychee = getItemStack("lychee_sapling");
		ItemStack saplingMango = getItemStack("mango_sapling");
		ItemStack saplingMaple = getItemStack("maple_sapling");
		...
		ItemStack saplingPaperbark = getItemStack("paperbark_sapling");
		ItemStack saplingPassionfruit = getItemStack("passionfruit_sapling");
		ItemStack saplingPawpaw = getItemStack("pawpaw_sapling");
		...
		ItemStack saplingRambutan = getItemStack("rambutan_sapling");
		ItemStack saplingSoursop = getItemStack("soursop_sapling");
		ItemStack saplingSpiderweb = getItemStack("spiderweb_sapling");
		ItemStack saplingStarfruit = getItemStack("starfruit_sapling");
		ItemStack saplingTamarind = getItemStack("tamarind_sapling");
		ItemStack saplingVanillaBean = getItemStack("vanillabean_sapling");
		...
		*/
		...
		/* INSOLATOR */
		{
			...
			InsolatorManager.addDefaultTreeRecipe(saplingBreadfruit, ItemHelper.cloneStack(itemBreadfruit, 4), saplingBreadfruit);
			...
			InsolatorManager.addDefaultTreeRecipe(saplingCinnamon, ItemHelper.cloneStack(itemCinnamon, 4), saplingCinnamon);
			...
			InsolatorManager.addDefaultTreeRecipe(saplingGuava, ItemHelper.cloneStack(itemGuava, 4), saplingGuava);
			InsolatorManager.addDefaultTreeRecipe(saplingHazelnut, ItemHelper.cloneStack(itemHazelnut, 4), saplingHazelnut);
			InsolatorManager.addDefaultTreeRecipe(saplingJackfruit, ItemHelper.cloneStack(itemJackfruit, 4), saplingJackfruit);
			...
			InsolatorManager.addDefaultTreeRecipe(saplingLychee, ItemHelper.cloneStack(itemLychee, 4), saplingLychee);
			InsolatorManager.addDefaultTreeRecipe(saplingMango, ItemHelper.cloneStack(itemMango, 4), saplingMango);
			InsolatorManager.addDefaultTreeRecipe(saplingMaple, ItemHelper.cloneStack(itemMapleSyrup, 4), saplingMaple);
			...
			InsolatorManager.addDefaultTreeRecipe(saplingPaperbark, ItemHelper.cloneStack(itemPaper, 4), saplingPaperbark);
			InsolatorManager.addDefaultTreeRecipe(saplingPassionfruit, ItemHelper.cloneStack(itemPassionfruit, 4), saplingPassionfruit);
			InsolatorManager.addDefaultTreeRecipe(saplingPawpaw, ItemHelper.cloneStack(itemPawpaw, 4), saplingPawpaw);
			...
			InsolatorManager.addDefaultTreeRecipe(saplingRambutan, ItemHelper.cloneStack(itemRambutan, 4), saplingRambutan);
			InsolatorManager.addDefaultTreeRecipe(saplingSoursop, ItemHelper.cloneStack(itemSoursop, 4), saplingSoursop);
			InsolatorManager.addDefaultTreeRecipe(saplingSpiderweb, ItemHelper.cloneStack(itemString, 4), saplingSpiderweb);
			InsolatorManager.addDefaultTreeRecipe(saplingStarfruit, ItemHelper.cloneStack(itemStarfruit, 4), saplingStarfruit);
			InsolatorManager.addDefaultTreeRecipe(saplingTamarind, ItemHelper.cloneStack(itemTamarind, 4), saplingTamarind);
			InsolatorManager.addDefaultTreeRecipe(saplingVanillaBean, ItemHelper.cloneStack(itemVanillaBean, 4), saplingVanillaBean);
