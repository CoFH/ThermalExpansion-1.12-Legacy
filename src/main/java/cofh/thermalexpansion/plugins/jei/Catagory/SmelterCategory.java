...
public class SmelterCategory extends CategoryBase {
    ...
    public void drawExtras(Minecraft minecraft) {
        ...
        //draws input slots.
        ResourceUtils.drawScaledTexturedRectFromModel(28, 22, 132, 96, 18, 18, JeiPlugin.JEI_HANDLER_LOCATION);
        ResourceUtils.drawScaledTexturedRectFromModel(48, 22, 132, 96, 18, 18, JeiPlugin.JEI_HANDLER_LOCATION);
        ...
        if (outputs.size() > 1) {
            ...
            stackGroup.addTooltipCallback(new ITooltipCallback<ItemStack>() {
                ...
                public void onTooltip(int slotIndex, boolean input, ItemStack ingredient, List<String> tooltip) {
                    if (slotIndex == 3) tooltip.add("chance: " + secondChance + "%");
                }
            });
        }
    }
