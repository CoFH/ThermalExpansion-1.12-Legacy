...
public class RecipeUidsTE {
	...
	public static final String COMPACTOR_STORAGE = "thermalexpansion.compactor_press";
	public static final String COMPACTOR_MINT = "thermalexpansion.compactor_press";
	...
	public static final String TRANSPOSER = "thermalexpansion.transposer";
