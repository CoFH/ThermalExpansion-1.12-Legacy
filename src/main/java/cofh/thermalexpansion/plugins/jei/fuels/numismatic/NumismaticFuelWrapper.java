...
public class NumismaticFuelWrapper extends BaseFuelWrapper {
	...
	public NumismaticFuelWrapper(IGuiHelper guiHelper, ItemStack fuel, int energy) {
		...
		IDrawableStatic progressDrawable = Drawables.getDrawables(guiHelper).getSpeedFill(8);
		IDrawableStatic energyDrawable = Drawables.getDrawables(guiHelper).getEnergyFill();

		burnFill = guiHelper.createAnimatedDrawable(progressDrawable, energy / TileDynamoNumismatic.basePower, StartDirection.TOP, true);
