...
public class TransposerCategory extends CategoryBase {
	...
	public TransposerCategory(boolean extraction) {
		...
		super(extraction ? "thermalexpansion.transposer.extract" : "thermalexpansion.transposer.insert", extraction ? "extraction" : "filling");
	...
	public void registerClickToShowCategoryAreas(IModRegistry registry) {
		...
		if (!extraction) {
			registry.addRecipeClickArea(GuiTransposer.class, 106, 16, 30, 24, uId);
		}
	}
	...
	public void drawExtras(Minecraft minecraft) {
		...
		//draws input slot.
		ResourceUtils.drawScaledTexturedRectFromModel(40, 16, 132, 96, 18, 18, JeiPluginTE.JEI_HANDLER_LOCATION);
		//draws input slot.
		ResourceUtils.drawScaledTexturedRectFromModel(72, 16, 132, 96, 18, 18, JeiPluginTE.JEI_HANDLER_LOCATION);
		//draws output slot.
		ResourceUtils.drawScaledTexturedRectFromModel(68, 40, 150, 96, 26, 26, JeiPluginTE.JEI_HANDLER_LOCATION);
		...
		ResourceUtils.drawScaledTexturedRectFromModel(151, 8, 80, 96, 18, 62, JeiPluginTE.JEI_HANDLER_LOCATION);
