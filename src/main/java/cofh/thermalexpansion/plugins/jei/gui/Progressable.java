 ...
 */
public class Progressable implements IPrograssable {
    ...
    public void draw(int progressTicks) {
        ...
        ResourceUtils.drawMixedTextures(x, y, u, appliedV, width, height, progress, JeiPlugin.JEI_HANDLER_LOCATION, JeiPlugin.JEI_HANDLER_LOCATION, reversed);
    }
    ...
    public boolean inBounds(int x, int y) {
        return this.x <= x && width + this.x >= x
    ...
    public static IPrograssable sawing(int x, int y, boolean reversed) {
        return new Progressable(225, 48, x, y, 15, 15, 8, reversed, true);
    }

    public static IPrograssable infusing(int x, int y, boolean reversed) {
