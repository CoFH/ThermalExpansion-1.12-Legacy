...
public class PowerBar implements IGuiResource {
	...
	@Override
	public List<String> getTooltip(int perTick) {
	...
	public void draw(int level) {
		...
		ResourceUtils.drawMixedTextures(x, y, 0, 96, WIDTH, Height, fillLevel, JeiPluginTE.JEI_HANDLER_LOCATION, JeiPluginTE.JEI_HANDLER_LOCATION, false);
	}

	@Override
	public boolean inBounds(int x, int y) {

		return this.x + 1 <= x && WIDTH + this.x >= x && this.y <= y && Height + this.y >= y;
	}
}
