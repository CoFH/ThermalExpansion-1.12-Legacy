...
public class ForestryPlugin {
	...
	public static void initialize() {
		...
		/* CENTRIFUGE */
		{
			CentrifugeManager.addRecipe(4000, combHoney, Arrays.asList(beeswax, honeyDrop), Arrays.asList(100, 40), null);
			CentrifugeManager.addRecipe(4000, combCocoa, Arrays.asList(beeswax, new ItemStack(Items.DYE, 1, 3)), Arrays.asList(100, 50), null);
			CentrifugeManager.addRecipe(4000, combSimmering, Arrays.asList(refractoryWax, ItemHelper.cloneStack(phosphor, 2)), Arrays.asList(100, 70), null);
			CentrifugeManager.addRecipe(4000, combStringy, Arrays.asList(propolis, honeyDrop), Arrays.asList(100, 40), null);
			CentrifugeManager.addRecipe(4000, combFrozen, Arrays.asList(beeswax, honeyDrop, new ItemStack(Items.SNOWBALL), pollenCrystalline), Arrays.asList(80, 70, 40, 20), null);
			CentrifugeManager.addRecipe(4000, combDripping, Arrays.asList(honeydew, honeyDrop), Arrays.asList(100, 40), null);
			CentrifugeManager.addRecipe(4000, combSilky, Arrays.asList(honeyDrop, propolisSilky), Arrays.asList(100, 80), null);
			CentrifugeManager.addRecipe(4000, combParched, Arrays.asList(beeswax, honeyDrop), Arrays.asList(100, 90), null);
			CentrifugeManager.addRecipe(4000, combMysterious, Arrays.asList(propolisPulsating, honeyDrop), Arrays.asList(100, 40), null);
			CentrifugeManager.addRecipe(4000, combPowdery, Arrays.asList(new ItemStack(Items.GUNPOWDER, 1), beeswax, honeyDrop), Arrays.asList(90, 20, 20), null);
			CentrifugeManager.addRecipe(4000, combWheat, Arrays.asList(new ItemStack(Items.WHEAT, 1), beeswax, honeyDrop), Arrays.asList(80, 20, 20), null);
			CentrifugeManager.addRecipe(4000, combMossy, Arrays.asList(beeswax, honeyDrop), Arrays.asList(100, 90), null);
			CentrifugeManager.addRecipe(4000, combMellow, Arrays.asList(honeydew, new ItemStack(Items.QUARTZ, 1), beeswax), Arrays.asList(60, 30, 20), null);

			CentrifugeManager.addRecipe(4000, propolisSilky, Arrays.asList(silkWisp, propolis), Arrays.asList(60, 10), null);
		}
