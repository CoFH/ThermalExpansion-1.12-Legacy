...
public class RecipeHandlerCraftingSecure extends ShapedRecipeHandler {

	public static RecipeHandlerCraftingSecure instance = new RecipeHandlerCraftingSecure();
	...
	public String getRecipeName() {
		...
		return StringHelper.localize("recipe.thermalexpansion.secure");
	}
