...
public class ValuedItem {
	...
	/**
	 * Presently unused but included so that if they do get used in the future, people including this in their jar and loading before MFR don't destroy everyone
	 */
