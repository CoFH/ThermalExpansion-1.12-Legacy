 ...
 * <p>
 * <p>
 * Forced connection modes are best used for decoration blocks: RedNet will not connect normally, but will if the user forces it. Typically, IRedNetDecorative
 * is desired for this instead
 * <p>
 ...
 * ForcedDecorativeSingle: Connections permit access to a single band, only when the cable is in forced connection mode <br>
