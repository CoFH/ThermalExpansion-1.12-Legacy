 ...
 * @author skyboy
 * 
 *         Defines a handler for mob spawns from the autospawner. Added primarily to solve item duping on exact spawn & entity inventories
 */
public interface IMobSpawnHandler {
	...
	/**
	 * @param entity
	 *            The entity instance being exact-copied. Clear your inventories & etc. here
	 */
