...
public interface IFactoryFruit {
	...
	/**
	 * Called by the Fruit Picker to determine what block to replace the picked block with. Only ID and meta/damage will be used. At the time this method is
	 * called, the fruit still exists. Do not pass an item ID as the return value.
	 * 
	 * @param world
	 *            The world where the fruit is being picked
	 * @param x
