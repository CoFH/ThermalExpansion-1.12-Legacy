...
/**
 * The Integration Table's primary purpose is to modify an input item's NBT data. As such its not a "traditional" type of recipe. Rather than predefined inputs
 * and outputs, it takes an input and transforms it.
 */
