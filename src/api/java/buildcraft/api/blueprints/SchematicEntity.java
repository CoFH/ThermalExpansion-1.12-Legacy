...
public class SchematicEntity extends Schematic {
	...
	/**
	 * This tree contains additional data to be stored in the blueprint. By default, it will be initialized from Schematic.readFromWord with the standard
	 * readNBT function of the corresponding tile (if any) and will be loaded from BptBlock.writeToWorld using the standard writeNBT function.
	 */
	public NBTTagCompound entityNBT = new NBTTagCompound();

	/**
	 * This field contains requirements for a given block when stored in the blueprint. Modders can either rely on this list or compute their own int Schematic.
	 */
