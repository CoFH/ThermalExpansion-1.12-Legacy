...
public interface ITrigger {
	...
	/**
	 * Every trigger needs a unique tag, it should be in the format of "<modid>:<name>".
	 * 
	...
	/**
	 * This returns the trigger after a left rotation. Used in particular in blueprints orientation.
	 */
	ITrigger rotateLeft();
}
