...
/**
 * The class MjAPI provides services to the Minecraft Joules power framework. BuildCraft implements a default power model on top of this, the "kinesis" power
 * model. Third party mods may provide they own version of Minecraft Joules batteries and provide different models.
 */
public final class MjAPI {
	...
	/**
	 * Returns the default battery related to the object given in parameter. For performance optimization, it's good to cache this object in the providing power
	...
	/**
	 * Returns the battery related to the object given in parameter. For performance optimization, it's good to cache this object in the providing power
	 * framework if possible.
	 */
