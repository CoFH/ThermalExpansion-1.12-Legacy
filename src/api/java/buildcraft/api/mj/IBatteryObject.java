...
public interface IBatteryObject {
	 ...
	 * @param mj
	 *            Energy amount
	 * @param ignoreCycleLimit
	 *            Force add all energy even if "maxReceivedPerCycle" limit is reached
	 * @return Used energy
	 */
	...
	/**
	 * Set current stored energy amount. Doesn't use it for your machines! Decrease your battery field directly.
	 * 
	 * @param mj
	 *            New energy amount
	 */
	...
	/**
	 * Allow to dynamically reconfigure your battery. Usually it's not very good change battery parameters for already present machines, but if you want...
	 * 
	 * @param maxCapacity
	 *            {@link #maxCapacity()}
	 * @param maxReceivedPerCycle
	 *            {@link #maxReceivedPerCycle()}
	 * @param minimumConsumption
	 *            {@link #minimumConsumption()}
