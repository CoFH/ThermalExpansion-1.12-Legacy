 ...
 * @author Azanor
 * 
 *         The tile entity used by nodes in the vis energy network. A node is either a source (like an aura node), a transport relay or vis receiver (like the
 *         infernal furnace).
 * 
 */
public abstract class TileVisNode extends TileThaumcraft {
	...
	/**
	 * @return the type of shard this is attuned to: none -1, air 0, fire 1, water 2, earth 3, order 4, entropy 5 Should return -1 for most implementations
	 */
