...
public class AspectList implements Serializable {
	...
	/**
	 * Reduces the amount of an aspect in this collection by the given amount. If reduced to 0 or less the aspect will be removed completely.
	 * 
	 * @param key
	 * @param amount
	 * @return
	...
	/**
	 * Adds this aspect and amount to the collection. If the aspect exists then its value will be increased by the given amount.
	 * 
	 * @param aspect
	 * @param amount
	 * @return
