...
public class AspectSourceHelper {
	...
	/**
	 * This method is what is used to drain essentia from jars and other sources for things like infusion crafting or powering the arcane furnace. A record of
	 * possible sources are kept track of and refreshed as needed around the calling tile entity. This also renders the essentia trail particles. Only 1
	 * essentia is drained at a time
	 * 
	 * @param tile
	 ...
	 * @param direction
	 *            the direction from which you wish to drain. Forgedirection.Unknown simply seeks in all directions.
	 * @param range
	...
	/**
	 * This method returns if there is any essentia of the passed type that can be drained. It in no way checks how much there is, only if an essentia container
