...
public class Aspect {
	 ...
	 * 
	 * @param tag
	 *            the key that will be used to reference this aspect, as well as its latin display name
	 * @param color
	...
	/**
	 * Shortcut constructor I use for the primal aspects - you shouldn't use this as making your own primal aspects will break all the things.
	 */
