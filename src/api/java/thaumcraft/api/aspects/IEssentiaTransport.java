...
/**
 * @author Azanor This interface is used by tiles that use or transport vis. Only tiles that implement this interface will be able to connect to vis conduits or
 *         other thaumic devices
 */
public interface IEssentiaTransport {
	...
	/**
	 * Return true if you want the conduit to extend a little further into the block. Used by jars and alembics that have smaller than normal hitboxes
	 * 
	 * @return
	 */
