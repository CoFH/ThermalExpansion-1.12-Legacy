...
public class ResearchItem {
	...
	/**
	 * This indicates if the research should use a circular icon border. Usually used for "passive" research that doesn't have recipes and grants passive
	...
	/**
	 * This indicated that the research is completely hidden and cannot be discovered by any player-controlled means. The recipes will never show up in the
	 * thaumonomicon. Usually used to unlock "hidden" recipes via sibling unlocking, like the various cap and rod combos for wands.
	 */
